 ...
 */
public class SimpleExpandableListAdapter2 extends BaseExpandableListAdapter {
     ...
     */
    public SimpleExpandableListAdapter2(Context context,
    ...
    private void bindView(View view, Map<String, ?> data, String[] from, int[] to) {
        int len = to.length;
        for (int i = 0; i < len; i++) {
            View vv = view.findViewById(to[i]);
            if (vv instanceof TextView){
                ...
                ImageView iv = (ImageView) view.findViewById(to[i]);
                if (iv != null){
                    iv.setImageResource(Integer.parseInt((String)data.get(from[i])));
                }
            }
        }
    }
