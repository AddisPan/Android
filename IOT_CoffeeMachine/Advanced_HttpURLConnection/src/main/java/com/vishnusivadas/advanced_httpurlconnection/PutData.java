...
//    public PutData(String url, String method, String[] field, Object[] dataObj) {
//        this.url = url;
//        this.method = method;
//        this.dataObj = new Object[dataObj.length];
//        this.field = new String[field.length];
//        System.arraycopy(field, 0, this.field, 0, field.length);
//        System.arraycopy(dataObj, 0, this.dataObj, 0, dataObj.length);
//    }
...
//                }else{
//                    post_data.append(URLEncoder.encode(this.field[i], "UTF-8")).append("=").append(URLEncoder.encode(this.dataObj[i], UTF8)).append("&");
//                }
            }
